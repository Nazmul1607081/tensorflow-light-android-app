...
public  class MultiBoxTracker {
  ...
  public String globallabel = "label";
  ...
  public synchronized boolean draw(final Canvas canvas,Context context) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      /*if(labelString.contains("backpack")||labelString.contains("frisbee")||labelString.contains("skis")||
              ...
              labelString.contains("tia")||labelString.contains("base")||labelString.contains("suitcase"))
      {
